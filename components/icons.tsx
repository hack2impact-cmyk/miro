...
export const LeafIcon: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 40 38" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path d="M20 37C11.3333 37 11.3333 24.3333 11.3333 18C11.3333 9.33333 15.6667 1 20 1C24.3333 1 28.6667 9.33333 28.6667 18C28.6667 24.3333 28.6667 37 20 37Z" fill="currentColor"/>
